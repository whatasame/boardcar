...
public class NearSiteUI extends AppCompatActivity
    ...
    private static final int UPDATE_INTERVAL_MS = 20000;  // 20초
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions( NearSiteUI.this, REQUIRED_PERMISSIONS,
    ...
    public void setDefaultLocation() {
        ...
        //디폴트 위치, KyeongSan
        LatLng DEFAULT_LOCATION = new LatLng(35.82, 128.74);
    ...
    private void showDialogForLocationServiceSetting() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(NearSiteUI.this);
