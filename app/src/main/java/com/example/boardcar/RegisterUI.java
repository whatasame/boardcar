...
import LoginPackage.RegisterUtil;
...
public class RegisterUI extends AppCompatActivity {
    ...
    String regInputIdStr, regInputPwStr, regCheckPwStr, regInputNameStr, regFindCarStr, regInputEmailStr, regEmailCheckStr, regCarNameStr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerBtn.setOnClickListener(new View.OnClickListener() { //회원가입 버튼클릭시 실행되는 모든것 다적어야함
            ...
            public void onClick(View view) {
                ...
                regCarNameStr = (regSelectCar.getText().toString());
                ...
                //이메일 인증 여부 확인하기
                //일단은 인증했다고 하고 api 사용해서 회원 등로 진행

                RegisterUtil registerUtil = new RegisterUtil(getBaseContext());
                if(registerUtil.registerUserInfo(regInputIdStr, regInputPwStr, regInputNameStr, regInputEmailStr, regCarNameStr)){
                    //회원가입에 성공했다면
                    AlertNoEditMsg("회원가입 성공", "회원가입에 성공했습니다. 로그인화면으로 돌아갑니다.");
                }else
                    AlertNoEditMsg("회원가입 실패", "회원가입에 실패하였습니다.");
